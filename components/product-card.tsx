        ...
        <Link href={`/product/${product.id}`} className="group block">
            <div className="bg-white rounded-lg border border-[#EBEBEB] overflow-hidden transition-all duration-200 hover:shadow-md hover:border-[#E0E0E0]">
                ...
                <div className="relative aspect-square bg-[#F8F8F8] overflow-hidden">
                    ...
                    {/* Badges */}
                    {product.isNew && (
                        <span className="absolute top-3 left-3 px-2 py-1 bg-[#1A1A1A] text-white text-[10px] font-semibold rounded">
                            NEW
                        </span>
                    )}
                </div>
                ...
                <div className="p-4">
                    ...
                    {/* Name */}
                    <h3 className="text-sm font-medium text-[#1A1A1A] mb-1 line-clamp-2 group-hover:text-[#B8975A] transition-colors">
                        {product.name}
                    </h3>
