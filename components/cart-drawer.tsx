                    ...
                    >
                        ...
                        <div className="px-6 py-4 border-b border-[#EBEBEB] flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                <ShoppingBag className="h-5 w-5 text-[#B8975A]" />
                        ...
                        <div className="flex-1 overflow-y-auto">
                            {isOrderPlaced ? (
                                    ...
                                    <div className="grid grid-cols-2 gap-3">
                                        <button
                                            ...
                                            className={`relative flex flex-col items-center justify-center p-4 border rounded-xl transition-all ${customerData.isDelivery === true
                                                ? 'border-[#B8975A] bg-[#F5F0EB]'
                                                : 'border-[#EBEBEB] bg-white hover:border-[#B8975A]/50'
                                                }`}
                                        >
                                            {customerData.isDelivery === true && (
                                                <div className="absolute top-2 right-2">
                                                    <Check className="h-4 w-4 text-[#B8975A]" />
                                                </div>
                                            )}
                                            <Truck className={`h-6 w-6 mb-2 ${customerData.isDelivery === true ? 'text-[#B8975A]' : 'text-[#717171]'}`} />
                                            <span className={`font-medium text-sm ${customerData.isDelivery === true ? 'text-[#B8975A]' : 'text-[#1A1A1A]'}`}>Delivery</span>
                                        ...
                                        >
                                            ...
                                            <Store className={`h-6 w-6 mb-2 ${customerData.isDelivery === false ? 'text-[#B8975A]' : 'text-[#717171]'}`} />
                                            <span className={`font-medium text-sm ${customerData.isDelivery === false ? 'text-[#B8975A]' : 'text-[#1A1A1A]'}`}>Store Pickup</span>
                                            ...
                                            >
                                                ...
                                                <div>
                                                    ...
                                                    <input
                                                        ...
                                                        className={`w-full px-4 py-3 border rounded-lg text-sm focus:outline-none focus:ring-2 transition-all ${errors.name
                                                            ...
                                                            : 'border-[#EBEBEB] focus:ring-[#B8975A]/20 focus:border-[#B8975A]'
                                                            }`}
                                                ...
                                                <div className="flex gap-3 pt-2">
                                                    ...
                                                    <button
                                                        ...
                                                        disabled={isSubmitting}
                                                        className="flex-1 py-3 bg-[#1A1A1A] text-white font-medium rounded-lg hover:bg-[#2C2C2C] transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
                                                    >
                                                        {isSubmitting ? (
                                                            <>
                                ...
                                <div className="h-full flex flex-col items-center justify-center text-center p-6 space-y-4">
                                    ...
                                    <button
                                        onClick={toggleCart}
                                        className="px-6 py-2.5 bg-[#1A1A1A] text-white font-medium rounded-lg hover:bg-[#2C2C2C] transition-colors"
                                    >
                                        Continue Shopping
                                    </button>
                                </div>
                                                ...
                                                <div className="flex items-center justify-between">
                                                    <div className="flex items-center gap-1 bg-white rounded-lg border border-[#EBEBEB]">
                                                        <button
                                                            ...
                                                            className="p-1.5 hover:bg-[#F8F8F8] transition-colors text-[#717171] hover:text-[#B8975A] rounded-l-lg"
                                                        ...
                                                        <button
                                                            onClick={() => updateQuantity(item.id, item.quantity + 1, item.selectedVariation?.id)}
                                                            className="p-1.5 hover:bg-[#F8F8F8] transition-colors text-[#717171] hover:text-[#B8975A] rounded-r-lg"
                                                        >
                        ...
                        {!isOrderPlaced && !showCustomerForm && items.length > 0 && (
                            <div className="p-4 border-t border-[#EBEBEB] bg-white space-y-4">
                                        ...
                                        <div className="flex gap-2">
                                            <div className="flex-1">
                                                <input
                                                    ...
                                                    className="w-full px-4 py-2.5 bg-[#F8F8F8] border border-[#EBEBEB] rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#B8975A]/20 focus:border-[#B8975A] transition-all"
                                                />
                                            </div>
                                            <button
                                ...
                                <button
                                    ...
                                    className="w-full py-3.5 bg-[#1A1A1A] text-white font-semibold rounded-lg hover:bg-[#2C2C2C] transition-colors flex items-center justify-center gap-2"
                                >
                                    {!user && (
