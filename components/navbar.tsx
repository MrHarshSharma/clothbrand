...
export default function Navbar() {
    ...
    const highlightMatch = (text: string, query: string) => {
        ...
        return parts.map((part, i) =>
            regex.test(part) ? <span key={i} className="text-[#B8975A] font-semibold">{part}</span> : part
        )
    }
    ...
    return (
        <>
                ...
                <div className="container mx-auto px-4 lg:px-8">
                    <div className="relative flex items-center justify-between h-24 md:h-28">
                            ...
                            <div ref={searchRef} className="relative w-72">
                                <form onSubmit={handleSearch} className="relative flex items-center">
                                    <input
                                        ...
                                        className="w-full pl-4 pr-16 py-2.5 border border-[#E0E0E0] rounded-md text-sm focus:outline-none focus:border-[#B8975A] transition-colors"
                                    />
                                    <div className="absolute right-3 inset-y-0 flex items-center gap-2">
                                        ...
                                        {isSearching ? (
                                            <div className="w-5 h-5 border-2 border-[#B8975A] border-t-transparent rounded-full animate-spin" />
                                        ) : (
                                            <button type="submit" className="text-[#666] hover:text-[#B8975A] flex items-center justify-center">
                                            ...
                                            <div className="overflow-y-auto max-h-[320px]">
                                                {isSearching ? (
                                                    <div className="flex items-center justify-center py-8">
                                                        <div className="w-6 h-6 border-2 border-[#B8975A] border-t-transparent rounded-full animate-spin"></div>
                                                    </div>
                                                    ...
                                                    <>
                                                        {searchResults.map((product) => {
                                                            ...
                                                            return (
                                                                <Link
                                                                    ...
                                                                    className="flex items-center gap-3 px-4 py-3 hover:bg-[#F7F4F0] transition-colors border-b border-[#F5F5F5] last:border-b-0"
                                                                >
                                                                    ...
                                                                    <div className="flex-1 min-w-0">
                                                                        ...
                                                                        <div className="flex items-center gap-2 mt-1">
                                                                            <span className="text-sm font-semibold text-[#B8975A]">
                                                        ...
                                                        {searchCount > searchResults.length && (
                                                            <button
                                                                ...
                                                                className="w-full py-3 text-sm font-medium text-[#B8975A] hover:bg-[#F7F4F0] transition-colors"
                                                            >
                        ...
                        <div className="flex items-center gap-4 md:gap-6 flex-1 justify-end">
                            ...
                            {loading ? (
                                ...
                                <div className="relative">
                                    <button
                                        ...
                                        className="flex flex-col items-center gap-1 hover:text-[#B8975A] transition-colors"
                                    >
                            ...
                            <button
                                onClick={toggleCart}
                                className="relative flex flex-col items-center gap-1 hover:text-[#B8975A] transition-colors"
                            >
                                <div className="relative">
                                    <ShoppingBag className="w-6 h-6 text-[#4A4A4A]" />
                                    {cartCount > 0 && (
                                        <span className="absolute -top-2 -right-2 w-5 h-5 bg-[#1A1A1A] text-white text-[10px] font-bold rounded-full flex items-center justify-center">
                                            {cartCount}
                                        </span>
                                    )}
                                </div>
            ...
            <nav className="sticky top-0 z-50 bg-[#1A1A1A] shadow-sm">
                <div className="container mx-auto px-4 lg:px-8">
                            ...
                            <div ref={mobileSearchRef} className="p-4 border-b border-[#EBEBEB]">
                                <form onSubmit={handleSearch} className="relative flex items-center">
                                    <input
                                        ...
                                        value={searchQuery}
                                        onChange={(e) => setSearchQuery(e.target.value)}
                                        className="w-full pl-4 pr-10 py-2.5 border border-[#E0E0E0] rounded-md text-sm focus:outline-none focus:border-[#B8975A]"
                                    />
                                    ...
                                    <div className="mt-3 bg-[#FAFAFA] rounded-lg border border-[#EBEBEB] max-h-[300px] overflow-y-auto">
                                        ...
                                        {isSearching ? (
                                            <div className="flex items-center justify-center py-6">
                                                <div className="w-5 h-5 border-2 border-[#B8975A] border-t-transparent rounded-full animate-spin"></div>
                                            </div>
                                        ) : searchResults.length > 0 ? (
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        ...
                                                        <div className="flex-1 min-w-0">
                                                            ...
                                                            <p className="text-xs font-semibold text-[#B8975A]">{formatPrice(priceInfo.current)}</p>
                                                        </div>
                                                    </Link>
                                                )
                                            })
                                ...
                                <div className="p-4 border-b border-[#EBEBEB]">
                                    {user ? (
                                        ...
                                        <button
                                            ...
                                            className="w-full py-3 bg-[#1A1A1A] text-white text-sm font-semibold rounded-lg hover:bg-[#2C2C2C] transition-colors"
                                        >
                                            Sign In with Google
                                        </button>
                                    )}
