    ...
    return (
        <div className="flex flex-col min-h-screen bg-[#FEFBF5] pt-24 pb-16">
            <div className="container mx-auto px-6 max-w-4xl">
                ...
                >
                    <h1 className="font-cormorant text-4xl font-bold text-[#2D1B1B] mb-4">Shipping Policy</h1>
                ...
                >
                    ...
                    <section className="space-y-4">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <h2 className="font-cormorant text-2xl text-[#2D1B1B]">International Shipping</h2>
                        </div>
                    ...
                    <section className="space-y-4">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <h2 className="font-cormorant text-2xl text-[#2D1B1B]">Order Processing</h2>
                        </div>
