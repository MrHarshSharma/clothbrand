                    ...
                    {isLoading ? (
                        <div className="flex flex-col items-center justify-center py-20">
                            <motion.div
                                ...
                                className="w-10 h-10 border-2 border-[#B8975A] border-t-transparent rounded-full"
                            />
                        ...
                        >
                            <div className="w-20 h-20 bg-[#F5F0EB] rounded-full flex items-center justify-center mx-auto mb-6">
                                <ShoppingBag className="h-10 w-10 text-[#B8975A]" />
                            </div>
                            ...
                            <Link
                                href="/products"
                                className="inline-flex items-center gap-2 px-8 py-3 bg-[#1A1A1A] text-white font-semibold rounded-lg hover:bg-[#2C2C2C] transition-colors"
                            >
                                Browse Products
                            </Link>
                        </motion.div>
                                            ...
                                            <div className="px-5 py-4 bg-[#F8F8F8] border-b border-[#EBEBEB] flex flex-wrap items-center justify-between gap-3">
                                                <div className="flex items-center gap-4">
                                                    <div className="flex items-center gap-2">
                                                        <Package className="h-5 w-5 text-[#B8975A]" />
