                ...
                <div className="container mx-auto px-6">
                    ...
                    >
                        ...
                        <p className="text-[#4A4A4A] text-lg leading-relaxed">
                            Fresh styles, just in. Discover the latest additions to our boutique — updated regularly so there&apos;s always something new.
                        </p>
                    </motion.div>
                </div>
            </section>
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-between gap-4 py-4">
                        ...
                        <form onSubmit={handleSearch} className="relative w-full sm:w-80">
                            <input
                                ...
                                className="w-full pl-4 pr-20 py-2.5 border border-[#E0E0E0] rounded-lg text-sm focus:outline-none focus:border-[#B8975A] transition-colors"
                            />
                            <div className="absolute right-2 inset-y-0 flex items-center gap-1">
                                ...
                                <button
                                    type="submit"
                                    className="p-1.5 bg-[#1A1A1A] text-white rounded-md hover:bg-[#2C2C2C] transition-colors"
                                >
                    ...
                    <AnimatePresence mode="wait">
                        {products.length === 0 ? (
                            ...
                            >
                                ...
                                <p className="text-xl font-semibold text-[#1A1A1A] mb-2">No new arrivals found</p>
                                <p className="text-[#717171]">
                                    {searchQuery
                                        ? `No results for "${searchQuery}" in new arrivals.`
                                        : 'New arrivals are coming soon. Check back shortly!'
                                    }
                                </p>
                                {searchQuery && (
                                    <button
                                        onClick={clearSearch}
                                        className="mt-6 px-6 py-2.5 bg-[#1A1A1A] text-white font-medium rounded-lg hover:bg-[#2C2C2C] transition-colors"
                                    >
                                        Clear Search
                                    </button>
                                )}
                            ...
                            <motion.div
                                key={`new-arrivals-${currentPage}-${currentSort}`}
                                initial={{ opacity: 0 }}
                                animate={{ opacity: 1 }}
                                exit={{ opacity: 0 }}
