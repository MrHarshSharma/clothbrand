    ...
    return (
        <div className="flex flex-col min-h-screen bg-[#FEFBF5] pt-24 pb-16">
            <div className="container mx-auto px-6 max-w-4xl">
                ...
                >
                    <h1 className="font-cormorant text-4xl font-bold text-[#2D1B1B] mb-4">Privacy Policy</h1>
                ...
                >
                    <section className="space-y-4">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <h2 className="font-cormorant text-2xl text-[#2D1B1B]">Data Collection</h2>
                        </div>
                        <p>We respect your privacy and are committed to protecting it. When you visit ClothingBrand, we collect information you provide directly to us, such as when you create an account, place an order, or contact us for support.</p>
                    ...
                    <section className="space-y-4">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <h2 className="font-cormorant text-2xl text-[#2D1B1B]">Use of Information</h2>
                        </div>
                    ...
                    <section className="space-y-4">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <h2 className="font-cormorant text-2xl text-[#2D1B1B]">Data Security</h2>
                        </div>
                    ...
                    <section className="space-y-4">
                        <h2 className="font-cormorant text-2xl text-[#2D1B1B]">Cookies</h2>
