    ...
    return (
        <div className="flex flex-col min-h-screen bg-[#FEFBF5] pt-24 pb-16">
            <div className="container mx-auto px-6 max-w-4xl">
                ...
                >
                    <h1 className="font-cormorant text-4xl font-bold text-[#2D1B1B] mb-4">Cancellations & Refunds</h1>
                ...
                >
                    <section className="space-y-4">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <h2 className="font-cormorant text-2xl text-[#2D1B1B]">Cancellations</h2>
                        </div>
                        <p>We accept order cancellations within 24 hours of placing the order. To cancel your order, please email us at support@clothingbrand.com or call us at 9665654326.</p>
                    ...
                    <section className="space-y-4">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <h2 className="font-cormorant text-2xl text-[#2D1B1B]">Returns</h2>
                        </div>
                    ...
                    <section className="space-y-4">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <h2 className="font-cormorant text-2xl text-[#2D1B1B]">Refund Process</h2>
                        </div>
                    ...
                    <section className="bg-orange-50/50 p-6 rounded-xl border-l-4 border-orange-200">
                        ...
                        <p className="text-sm">For any questions related to refunds and returns, please contact our support team at support@clothingbrand.com.</p>
                    </section>
                </motion.div>
            </div>
        </div>
